...
class Story(object):
    ...
    def add_trait(self, name: str, in_game_name: str, decription: str, antonym=None):
        """Add a trait, aswell as the antonym if it's not None"""
        pass


    def add_class(self, class_name: str, trait_value_dict: dict):
...
def load_story_from_json(json_content: json):
